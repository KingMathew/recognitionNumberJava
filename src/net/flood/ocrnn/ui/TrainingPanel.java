...
public class TrainingPanel extends JPanel implements CharacterTrainer.TrainListener, CharacterTester.TesterListener {
    ...
    private void initComponents() {
        loadTrainingLabel = new JLabel("Subir archivos de entrenamiento.");
        loadTestLabel = new JLabel("Subir archivos de prueba.");
        loadTrainingImageButton = new JButton("Subir imagenes");
        loadTrainingLabelButton = new JButton("Subir etiquetas");
        loadTestImageButton = new JButton("Subir imagenes");
        loadTestLabelButton = new JButton("Subir etiquetas");
        loadTrainingFileLabel = new JLabel("");
        loadTestFileLabel = new JLabel("");
        exportModelButton = new JButton("Modelo de exportación");
        importModelButton = new JButton("Modelo de importación");
        trainingTitle = new JLabel("Estado de entrenamiento");
        trainingTitle.setFont(trainingTitle.getFont().deriveFont(Const.TITLE_FONT_SIZE));
        trainingProgressBar = new JProgressBar();
        epochLabel = new JLabel("Etapa : 0");
        performanceLabel = new JLabel("Performance : 0%");
        controlButton = new JButton("Iniciar");
    ...
    public void onTrainEpochEnd() {
        SwingUtilities.invokeLater(() -> {
            epochLabel.setText("Etapa: " + trainer.getEpoch());
        });
    }
