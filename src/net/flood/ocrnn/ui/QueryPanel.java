        ...
        task.setListener(result -> {
            try {
                SwingUtilities.invokeAndWait(() -> {
                    ...
                    confidenceLabel.setText("Fidelidad: " + String.format("%.2f%%",
